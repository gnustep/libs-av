...
- (uint64_t) address { return 0; }
- (NSString *) displayName { return nil; }
- (NSString *) identifier { return nil; }
- (AUValue) value { return 0.0f; }
- (AUValue) minValue { return 0.0f; }
- (AUValue) maxValue { return 0.0f; }
- (NSString *) unitName { return nil; }
...
- (NSArray *) allParameters { return [NSArray array]; }
...
- (NSDictionary *) fullState { return [NSDictionary dictionary]; }
- (void) setFullState: (NSDictionary *)state { (void)state; }
- (AUParameterTree *) parameterTree
{
  return [[[AUParameterTree alloc] init] autorelease];
}
- (AUScheduleMIDIEventBlock) scheduleMIDIEventBlock { return nil; }
...
- (void) setFilterType: (AVAudioUnitEQFilterType)filterType { (void)filterType; }
- (void) setFrequency: (float)frequency { (void)frequency; }
- (void) setBypass: (BOOL)bypass { (void)bypass; }
@end
  ...
  if ((self = [super init]))
    {
      ...
      for (index = 0; index < numberOfBands; index++)
        [_bands addObject: [[[AVAudioUnitEQFilterParameters alloc] init] autorelease]];
    }
  return self;
}
- (NSArray *) bands { return _bands; }
- (void) setGlobalGain: (float)globalGain { _globalGain = globalGain; }
- (void) dealloc
{
  [_bands release];
  [super dealloc];
...
- (void) setDelayTime: (NSTimeInterval)delayTime { (void)delayTime; }
- (void) setFeedback: (float)feedback { (void)feedback; }
- (void) setWetDryMix: (float)wetDryMix { (void)wetDryMix; }
@end

@implementation AVAudioUnitReverb
- (void) loadFactoryPreset: (AVAudioUnitReverbPreset)preset { (void)preset; }
- (void) setWetDryMix: (float)wetDryMix { (void)wetDryMix; }
@end
...
- (NSString *) manufacturerName { return nil; }
- (NSDictionary *) configurationDictionary { return [NSDictionary dictionary]; }
- (BOOL) hasCustomView { return NO; }
- (BOOL) isSandboxSafe { return YES; }
- (BOOL) passesAUVal { return YES; }
- (NSString *) versionString { return nil; }
@end
